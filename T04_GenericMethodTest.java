...
class Util{
	public static <K, V> boolean compare(Pair<K, V> p1,Pair<K, V> p2) {
		...
		boolean valueCopare = p1.getValue().equals(p2.getValue());
		
		return keyCompare && valueCopare;
	}
}	
/**
...
public class T04_GenericMethodTest {
	...
	boolean result1 =Util.<Integer, String>compare(p1, p2);	//구체적 타입을 명식적으로 지정(생략 가능)
		...
		boolean result2 =Util.compare(p3, p4);				//구체적 타입을 명식적으로 지정(생략 가능)
